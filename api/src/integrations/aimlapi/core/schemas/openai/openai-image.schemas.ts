...
export const GptImageQualityEnum = z.enum([
    "low",
    "medium",
    "high",
]);

export const GptImageSizeEnum = z.enum([
    "1024x1024",
    "1024x1536",
    "1536x1024",
]);

export const GptImageResponseFormatEnum = z.enum([
    "url",
    "b64_json",
]);
...
export type Dalle3ImageGenerationInput = z.infer<typeof Dalle3ImageGenerationSchema>;