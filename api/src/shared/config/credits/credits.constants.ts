...
export const MODEL_PROVIDER_COST_DOLLARS: Record<string, number> = {
  ...
  'klingai/video-v2-6-pro-image-to-video': 0.091,
  'klingai/video-o1-image-to-video': 0.118,
  'klingai/v2.5-turbo/pro/image-to-video': 0.091,
  'kling-video/v1/pro/image-to-video': 0.103,
  'kling-video/v1.6/standard/multi-image-to-video': 0.059,
  'kling-video/v2.1/standard/image-to-video': 0.059,
  ...
  'google/veo-3.1-i2v': 0.104,
  'veo2/image-to-video': 0.455,
  'alibaba/wan2.5-i2v-preview': 0.065,
  'ltxv/ltxv-2': 0.78,
