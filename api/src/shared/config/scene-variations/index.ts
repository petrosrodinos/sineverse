...
export const DEPTH_OF_FIELD_VALUES = ['shallow', 'deep'] as const;
...
export const RESOLUTION_VALUES = ['720p', '1080p', '1440p', '4k'] as const;

export const AI_MODELS = ['VEO3', 'RUNWAY', 'PIKA', 'STABILITY'] as const;

export const DURATION_VALUES = [2, 3, 4, 5, 6, 8, 10, 15] as const;

export const MOTION_STRENGTH_VALUES = [0.1, 0.25, 0.5, 0.75, 1] as const;
