...
import {
  EnrichImagePromptConfig,
  EnrichProjectConceptConfig,
  EnrichSceneVariationConfig,
  GenerateAiScenesConfig,
} from '../interfaces/ai-helper.interfaces';
import {
  GenerateAiScenesSchema,
  GenerateAiScenesSchemaType,
  ProjectAssetVideoSchema,
  ProjectAssetVideoSchemaType,
} from '../schemas/scene-variation.schema';
...
export class AiHelperService {
  ...
  async enrichSceneVariation(
    config: EnrichSceneVariationConfig,
  ): Promise<ProjectAssetVideoSchemaType> {
    try {
  ...
  ): Promise<GenerateAiScenesSchemaType> {
    try {
  ...
  async enrichImagePrompt(
    config: EnrichImagePromptConfig,
