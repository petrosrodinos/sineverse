...
const steps = [
  {
    ...
    body: "One sentence is enough. We expand it into a structured story.",
  },
  {
    title: "Generate scenes",
    body: "AI produces cinematic clips with tuned prompts and variations.",
  },
  {
    title: "Assemble on the timeline",
    body: "Arrange, trim, and refine without traditional frame editing.",
  },
  {
    title: "Publish",
    body: "Ship your film and prepare it for discovery and streaming.",
  },
] as const;
  ...
  return (
    <LandingHashScroll pathnameMatch="/sineverse">
      <div className="min-h-screen bg-background">
          ...
          <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-16 md:pb-32 md:pt-24">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-pretty text-lg text-default-500 md:text-xl">
                {environments.APP_NAME} enriches your concept, breaks it into
                scenes, generates optimized prompts, and helps you assemble and
                publish without a traditional video editor.
              </p>
            ...
            <div className="mx-auto mt-16 max-w-5xl">
              <div className="relative rounded-2xl border border-divider/60 bg-content1/40 p-1 shadow-2xl shadow-black/20 backdrop-blur-sm dark:bg-content1/30">
                <div className="flex aspect-[21/9] min-h-[200px] flex-col items-center justify-center gap-4 rounded-xl bg-gradient-to-br from-background-100 via-background to-background-200 dark:from-background-200 dark:via-background dark:to-background-100 md:min-h-[280px]">
                  ...
                  <p className="text-center text-sm text-default-500 md:text-base">
                    Your studio canvas preview
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="mx-auto max-w-2xl text-center">
              <h2 className="text-3xl font-semibold tracking-tight text-foreground md:text-4xl">
                Built for filmmakers, not admin panels
              </h2>
              <p className="mt-4 text-lg text-default-500">
                Premium, minimal, and immersive by design.
              </p>
            </div>
        ...
        <section className="border-b border-divider/40 py-20 md:py-28">
          <div className="mx-auto max-w-7xl px-6">
            <div className="mx-auto max-w-2xl text-center">
              ...
              <p className="mt-4 text-lg text-default-500">
                A linear path from idea to finished film.
              </p>
            </div>
        ...
        <section
          className="scroll-mt-24 border-t border-divider/40 bg-content1/20 py-20 md:py-24"
          id="about"
        >
          <div className="mx-auto max-w-7xl px-6">
            <div className="mx-auto max-w-3xl pb-16 text-center md:pb-20">
              <h2 className="text-3xl font-semibold tracking-tight text-foreground md:text-4xl">
                About {environments.APP_NAME}
              </h2>
              <p className="mt-6 text-lg leading-relaxed text-default-500">
                We build software for people who want films to emerge from
                ideas, not from months in a traditional edit suite. Our pipeline
                is scene-first: structure the story, generate with the right
                prompts, refine variations, and assemble on a timeline made for
                AI footage. Streaming and discovery are on the roadmap so
                finished work can reach an audience the way audiences expect
                today.
              </p>
            </div>
            <div className="flex flex-col items-center justify-between gap-10 rounded-2xl border border-divider/50 bg-gradient-to-br from-primary/10 via-background to-background p-10 md:flex-row md:p-14 lg:p-16">
              <div className="max-w-xl text-center md:text-left">
                ...
                <p className="mt-4 text-lg text-default-500">
                  Create an account, open the studio, and move from first prompt
                  to first cut in one session.
                </p>
              </div>
              <Button
                as={NextLink}
