...
const keyFeatures = [
  ...
  { icon: Layers, title: "Smart scene ordering (living room to bedroom and more)" },
  { icon: Music, title: "Background music auto-added" },
  { icon: Captions, title: "Automatic captions for your tour" },
  { icon: Smartphone, title: "Vertical and horizontal formats (Reels, TikTok, listings)" },
  ...
  return (
    <div className="min-h-screen bg-background">
      <section className="relative overflow-hidden border-b border-divider/40">
        ...
        <div className="relative mx-auto max-w-7xl px-6 pb-20 pt-16 md:pb-28 md:pt-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-balance text-4xl font-semibold leading-tight tracking-tight text-foreground md:text-5xl lg:text-6xl">Turn Your Property Photos Into Stunning AI Video Tours in Seconds</h1>
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
              <Button as={NextLink} href={Routes.auth.sign_up} color="primary" size="lg" radius="full" className="min-w-[240px] font-semibold shadow-lg shadow-primary/25" endContent={<ArrowRight className="size-4" />}>
      ...
      <section className="border-b border-divider/40 py-20 md:py-28">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-semibold tracking-tight text-foreground md:text-4xl">Benefits</h2>
            <p className="mt-4 text-lg text-default-500">You are not selling AI video — you are selling more bookings and faster sales.</p>
          </div>
          <ul className="mx-auto mt-12 grid max-w-3xl gap-3">
            {benefitLines.map((line) => (
              <li key={line} className="flex gap-3 text-lg text-default-600">
                <TrendingUp className="mt-1 size-5 shrink-0 text-primary" strokeWidth={2} />
                {line}
              </li>
            ))}
          </ul>
      ...
      <section id="about" className="relative scroll-mt-24 overflow-hidden border-b border-divider/40 py-20 md:py-28">
      ...
      <section className="border-t border-divider/40 bg-content1/20 py-20 md:py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="flex flex-col items-center justify-between gap-10 rounded-2xl border border-divider/50 bg-gradient-to-br from-primary/10 via-background to-background p-10 md:flex-row md:p-14 lg:p-16">
            ...
            <Button as={NextLink} href={Routes.auth.sign_up} color="primary" size="lg" radius="full" className="shrink-0 min-w-[240px] font-semibold shadow-lg shadow-primary/25" endContent={<ArrowRight className="size-4" />}>
