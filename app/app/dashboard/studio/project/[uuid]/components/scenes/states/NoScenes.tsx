...
export function NoScenes({ onOpen }: NoScenesProps) {
  return (
    <aside className="w-full lg:w-72 max-h-[300px] lg:max-h-none shrink-0 flex flex-col gap-4 rounded-2xl border border-default-200 bg-default-100 dark:border-default-100/20 dark:bg-default-100/5 p-4 items-center justify-center text-center">
