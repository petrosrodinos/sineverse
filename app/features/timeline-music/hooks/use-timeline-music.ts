...
const QueryKeys = {
    timelineMusic: (finalProjectUuid: string) => ["timeline-music", finalProjectUuid],
};
...
export const useUpsertTimelineMusic = () => {
    ...
    return useMutation<TimelineMusic | null, Error, { finalProjectUuid: string; dto: UpsertTimelineMusicDto }>({
